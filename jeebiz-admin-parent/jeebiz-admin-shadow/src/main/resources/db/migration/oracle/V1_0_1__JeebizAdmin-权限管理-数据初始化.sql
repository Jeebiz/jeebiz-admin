...
DELETE FROM sys_authz_user_account;
DELETE FROM sys_authz_user_profile;
DELETE FROM sys_authz_role_perms;
DELETE FROM sys_authz_user_roles;
...
INSERT INTO sys_authz_user_profile(u_pid, u_id, nickname, u_avatar, u_region_code, u_phone, u_email, u_birthday, u_gender, u_idcard, u_age, u_height, u_weight, u_language, u_intro, u_photos, u_province, u_city, u_area, u_wgs84_lng, u_wgs84_lat, u_degree)
...
INSERT INTO sys_authz_user_roles ( u_id, r_id, r_prty)
VALUES ( '1', '1', '0');
