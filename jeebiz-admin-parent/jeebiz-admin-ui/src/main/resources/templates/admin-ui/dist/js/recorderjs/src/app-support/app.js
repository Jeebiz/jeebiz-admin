	...
	,{
		...
		,Config:{
			...
			,AMREngine:[
                ...
                , {
                    url: BaseFolder + "engine/mp3.js", check: function () {
...
,AlwaysUseWeixinJS:true //测试用的，微信里面总是使用微信的接口，方便Android上调试  TODO
,Platforms:{
	Native:Native
	,Weixin:Weixin
	,Default:Default
...
,Stop:function(success,fail){
	...
	if(!cur){
        ...
        cur.Stop(function (obj) {
            var bstr = Base64.decode(obj.data), n = bstr.length, u8arr = new Uint8Array(n);
		while(n--){
