...
var RecordAppBaseFolder = window.PageSet_RecordAppBaseFolder || "https://mhk.zjhzyx.com/mhk/assets/js/recorderjs/src/";
//请使用自己的素材下载接口，不要用我的，微信【强制】要【绑安全域名】，别的站用不了
var MyWxApi = "https://mhk.zjhzyx.com/mhk/mobile/online/wechat/record";
...
config.DownWxMedia=function(param,success,fail){
	...
	*/
	...
	ajax(MyWxApi,{
        ...
        , quId: thisRecordStop.parents('div[type="speaking"]:visible').attr('data-quid')
        , ifMock: $("#ifMock").val()
        , paperId: $("#paperId").val()
	},function(data){
		success(data.v);
...
var InitJsSDK=function(App,MyWxApi,ajax){
	...
	App.Js([{url:"https://res2.wx.qq.com/open/js/jweixin-1.4.0.js",check:function(){return true}}],function(){
