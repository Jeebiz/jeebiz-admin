...
insert into zftal_xtgl_jsgnmkdmb(GNMKDM, GNMKMC, FJGNDM, DYYM, XSSX,CDJB,GNSYDX) values ('N0160','消息服务','N01', '', '1', '1', 'gl'); 

/*网络环境参数*/
insert into zftal_xtgl_jsgnmkdmb(GNMKDM, GNMKMC,FJGNDM, DYYM, XSSX, SFXS, SFZDYMK, XSLX) values ('N016010','网络环境参数','N0160','/ms/network/settings.zf', '1', '1', '0', '0'); 
...
/*短信服务参数*/
insert into zftal_xtgl_jsgnmkdmb(GNMKDM, GNMKMC,FJGNDM, DYYM, XSSX, SFXS, SFZDYMK, XSLX) values ('N016015','短信服务参数','N0160','/ms/sms/settings.zf', '1', '1', '0', '0'); 
...
/*邮件服务参数*/
insert into zftal_xtgl_jsgnmkdmb(GNMKDM, GNMKMC,FJGNDM, DYYM, XSSX, SFXS, SFZDYMK, XSLX) values ('N016020','邮件服务参数','N0160','/ms/mailclient/settings.zf', '1', '1', '0', '0'); 
