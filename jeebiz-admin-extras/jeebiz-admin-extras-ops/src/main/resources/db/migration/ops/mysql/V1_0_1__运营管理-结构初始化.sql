...
-- ----------------------------
-- Table structure for $${table-prefix}stats_payment
-- ----------------------------
DROP TABLE IF EXISTS `$${table-prefix}stats_payment`;
CREATE TABLE `$${table-prefix}stats_payment` (
...
-- ----------------------------
-- Table structure for $${table-prefix}stats_payment_remain
-- ----------------------------
DROP TABLE IF EXISTS `$${table-prefix}stats_payment_remain`;
CREATE TABLE `$${table-prefix}stats_payment_remain` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `app_id` varchar(11) DEFAULT NULL COMMENT '客户端应用ID',
  `app_channel` varchar(255) DEFAULT NULL COMMENT '客户端应用渠道编码',
  `app_version` varchar(20) DEFAULT NULL COMMENT '客户端版本',
  `day` date NOT NULL COMMENT '日期，yyyy-MM-dd',
  `dpu` bigint(12) DEFAULT NULL COMMENT '新增付费用户数',
...
-- ----------------------------
-- Table structure for $${table-prefix}stats_user_remain
-- ----------------------------
DROP TABLE IF EXISTS `$${table-prefix}stats_user_remain`;
CREATE TABLE `$${table-prefix}stats_user_remain` (
 `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
 `app_id` varchar(11) DEFAULT NULL COMMENT '客户端应用ID',
 `app_channel` varchar(255) DEFAULT NULL COMMENT '客户端应用渠道编码',
 `app_version` varchar(20) DEFAULT NULL COMMENT '客户端版本',
