...
public class BusinessLog4j2Aspect {
    ...
    /*<aop:config>
		<aop:pointcut id="logPointcut"  expression="execution(* io.hiwepy..controller.*.*(..)) and @annotation(io.hiwepy.boot.api.annotation.BusinessLog) and @annotation(businessLog)" />
