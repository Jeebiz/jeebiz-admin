...
public class ArticleRenewVo {
	 ...
	 * 文章发布对象
	 */
	@ApiModelProperty(name = "targets", dataType = "java.util.List<ArticleTargetRenewVo>", value = "文章发布对象")
	private List<ArticleTargetRenewVo> targets;
	/**
	 * 文章封面
	 */
