...
@ApiModel(value = "ArticleVo", description = "文章内容Vo")
@Data
public class ArticleVo {
	 ...
	 * 文章发布对象
	 */
	@ApiModelProperty(name = "targets", dataType = "java.util.List<ArticleTargetVo>", value = "文章发布对象")
	private List<ArticleTargetVo> targets;
	/**
	 * 文章封面
	 */
