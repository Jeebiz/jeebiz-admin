...
@ApiModel(value = "ArticleTopicTreeVo", description = "文章栏目树Vo")
@Data
public class ArticleTopicTreeVo implements Comparable<ArticleTopicTreeVo>{
	 ...
	 * 子文章栏目集合
	 */
	@ApiModelProperty(name = "children", dataType = "java.util.List<ArticleTopicTreeVo>", value = "子文章栏目集合")
	private List<ArticleTopicTreeVo> children;
	
	/**
	 * 创建ztree的根节点
	 */
	public static ArticleTopicTreeVo createRoot() {
		ArticleTopicTreeVo myTreeNode = new ArticleTopicTreeVo();
		myTreeNode.setId("0");
	...
	@Override
	public int compareTo(ArticleTopicTreeVo o) {
