...
CREATE TABLE IF NOT EXISTS `t_feature_list` (
  ...
  `f_path` varchar(500) NOT NULL DEFAULT '#' COMMENT '功能菜单路径',
  `f_component` varchar(500) DEFAULT '' COMMENT '功能菜单对应页面相对路径',
  ...
  `f_parent` bigint(12) NOT NULL COMMENT '父级功能菜单id',
...
CREATE TABLE IF NOT EXISTS `t_feature_opts` (
  ...
  `opt_perms` varchar(50) NOT NULL COMMENT '功能操作权限标记',
  PRIMARY KEY (`opt_id`),
