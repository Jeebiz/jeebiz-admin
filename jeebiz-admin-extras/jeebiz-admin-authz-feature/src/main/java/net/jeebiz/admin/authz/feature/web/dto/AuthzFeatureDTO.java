...
@ApiModel(value = "AuthzFeatureDTO", description = "功能信息DTO")
@Getter
@Setter
@ToString
public class AuthzFeatureDTO implements Comparable<AuthzFeatureDTO>{
	 ...
	 * 子菜单或功能按钮
	 */
	@ApiModelProperty(name = "children", dataType = "java.util.List<AuthzFeatureDTO>", value = "子菜单")
	private List<AuthzFeatureDTO> children = Lists.newArrayList();
	/**
	 * 功能按钮
	 */
	@ApiModelProperty(name = "opts", dataType = "java.util.List<AuthzFeatureOptDTO>", value = "功能按钮：没有子菜单时该数据才有值")
	private List<AuthzFeatureOptDTO> opts = Lists.newArrayList();

	@Override
	public int compareTo(AuthzFeatureDTO o) {
		try {
