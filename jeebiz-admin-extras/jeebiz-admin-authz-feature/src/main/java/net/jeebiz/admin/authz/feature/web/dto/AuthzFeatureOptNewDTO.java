...
@ApiModel(value = "AuthzFeatureOptNewDTO", description = "新增功能操作参数DTO")
@Getter
@Setter
@ToString
public class AuthzFeatureOptNewDTO implements Comparable<AuthzFeatureOptNewDTO> {
	...
	@Override
	public int compareTo(AuthzFeatureOptNewDTO o) {
