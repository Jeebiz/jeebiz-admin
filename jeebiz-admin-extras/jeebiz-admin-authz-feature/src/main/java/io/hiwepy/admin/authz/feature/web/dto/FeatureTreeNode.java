...
@ApiModel(value = "FeatureTreeNode", description = "功能树节点信息")
@Getter
@Setter
@ToString
public class FeatureTreeNode implements Comparable<FeatureTreeNode>{
	...
	private List<FeatureTreeNode> children = Lists.newArrayList();

	@Override
	public int compareTo(FeatureTreeNode o) {
