...
@ApiModel(value = "AuthzFeatureNewDTO", description = "新增功能菜单参数DTO")
@Getter
@Setter
@ToString
public class AuthzFeatureNewDTO implements Comparable<AuthzFeatureNewDTO> {
	...
	@Override
	public int compareTo(AuthzFeatureNewDTO o) {
