...
@ApiModel(value = "OrganizationTreeDTO", description = "机构信息DTO")
...
public class OrganizationTreeDTO implements Serializable, Comparable<OrganizationTreeDTO> {
	 ...
	 * 子菜单或功能按钮
	 */
	@ApiModelProperty(name = "children", dataType = "java.util.List<OrganizationTreeDTO>", value = "子菜单")
	private List<OrganizationTreeDTO> children = Lists.newArrayList();
