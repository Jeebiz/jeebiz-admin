...
@ApiModel(value = "AuthzOrganizationTreeVo", description = "机构信息Vo")
@SuppressWarnings("serial")
@Getter
@Setter
@ToString
public class AuthzOrganizationTreeVo implements Serializable {
	 ...
	 * 子菜单或功能按钮
	 */
	@ApiModelProperty(name = "children", dataType = "java.util.List<AuthzOrganizationTreeVo>", value = "子菜单")
	private List<AuthzOrganizationTreeVo> children = Lists.newArrayList();
