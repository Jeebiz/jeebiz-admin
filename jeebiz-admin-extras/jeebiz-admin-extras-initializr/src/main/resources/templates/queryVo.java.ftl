...
<#if swagger2>
@ApiModel(value="${table.comment!}列表查询传输层对象", description="${table.comment!}列表查询传输层对象")
</#if>
public class ${cfg.entityName?replace('Model','QueryVo')} implements Serializable {
<#-- ----------  BEGIN 字段循环遍历  ---------->
