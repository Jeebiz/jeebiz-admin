...
<#if swagger2>
@ApiModel(value="${table.comment!}传输层返回对象", description="${table.comment!}传输层返回对象")
</#if>
public class ${cfg.entityName?replace('Model','ResultVo')} implements Serializable {
<#-- ----------  BEGIN 字段循环遍历  ---------->
