package io.hiwepy.admin.extras.xxljob.service.impl;
...
import io.hiwepy.admin.extras.xxljob.dao.XxlJobInfoMapper;
import io.hiwepy.admin.extras.xxljob.dao.XxlJobLogGlueMapper;
import io.hiwepy.admin.extras.xxljob.dao.XxlJobLogMapper;
import io.hiwepy.admin.extras.xxljob.dao.XxlJobLogReportMapper;
...
public class XxlJobServiceImpl implements IXxlJobService {
	...
	public ReturnT<String> addOrUpdate(XxlJobInfo jobInfo) {
		// valid
		XxlJobInfo oldJobInfo = xxlJobInfoMapper.loadByGroup(jobInfo.getJobGroup(), jobInfo.getExecutorHandler());
		if (oldJobInfo == null) {
			return this.add(jobInfo);
		}
		jobInfo.setId(oldJobInfo.getId());
