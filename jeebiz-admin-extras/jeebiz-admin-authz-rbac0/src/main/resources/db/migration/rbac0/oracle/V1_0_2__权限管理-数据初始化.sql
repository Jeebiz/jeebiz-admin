...
DELETE FROM sys_authz_user_roles WHERE r_id = '8BA8036C5A8B05E1E050007F010072D3';
...
INSERT INTO sys_authz_user_account ( u_id, u_username, u_password, u_salt, u_secret, u_alias, u_avatar, u_phone, u_email, U_REMARK, u_status  )
