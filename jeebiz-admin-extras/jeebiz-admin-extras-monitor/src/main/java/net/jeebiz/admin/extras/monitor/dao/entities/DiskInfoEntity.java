...
public class DiskInfoEntity extends Model<DiskInfoEntity> {
	...
	public DiskInfoEntity(String sessionId, String host, String startTimestamp, String lastAccessTime,
                          long timeout) {
	...
	public DiskInfoEntity(SimpleDateFormat dateFormat, Session session) {
