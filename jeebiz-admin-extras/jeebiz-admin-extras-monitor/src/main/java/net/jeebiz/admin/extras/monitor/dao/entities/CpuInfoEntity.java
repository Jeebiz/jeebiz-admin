...
public class CpuInfoEntity extends Model<CpuInfoEntity> {
	...
	public CpuInfoEntity(String sessionId, String host, String startTimestamp, String lastAccessTime,
                         long timeout) {
	...
	public CpuInfoEntity(SimpleDateFormat dateFormat, Session session) {
