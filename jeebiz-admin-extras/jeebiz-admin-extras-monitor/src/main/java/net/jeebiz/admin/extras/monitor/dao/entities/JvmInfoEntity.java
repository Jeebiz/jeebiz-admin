...
public class JvmInfoEntity extends Model<JvmInfoEntity> {
	...
	public JvmInfoEntity(String sessionId, String host, String startTimestamp, String lastAccessTime,
                         long timeout) {
	...
	public JvmInfoEntity(SimpleDateFormat dateFormat, Session session) {
