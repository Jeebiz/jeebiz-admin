...
public class MemInfoEntity extends Model<MemInfoEntity> {
	...
	public MemInfoEntity(String sessionId, String host, String startTimestamp, String lastAccessTime,
                         long timeout) {
	...
	public MemInfoEntity(SimpleDateFormat dateFormat, Session session) {
